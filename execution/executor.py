...
from execution.risk import RiskEngine, DEFAULT_PARAMS, _get_pair_lock
...
class Executor:
    ...
    def execute(self, thesis, params=None):
        ...
        with _get_pair_lock(pair):
            approved, reason, units = self.risk.approve(
                pair, thesis, params=params,
                fundamentals={"news_blackout": thesis.get("news_blackout", (False, None, None))}
            )
